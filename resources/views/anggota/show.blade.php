                    ...
                    <div class="card-body">
                      ...
                      <form class="forms-sample">
                        ...
                        <div class="form-group{{ $errors->has('nisn') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nisn" type="number" class="form-control" name="nisn" value="{{ $data->nisn }}" maxlength="8" readonly>
                                @if ($errors->has('nisn'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('kelas') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="kelas" required="" disabled="">
                                <option value=""></option>
                                <option value="10" {{$data->kelas === "10" ? "selected" : ""}} >Kelas 10</option>
                                <option value="11" {{$data->kelas === "11" ? "selected" : ""}} >Kelas 11</option>
                                <option value="12" {{$data->kelas === "12" ? "selected" : ""}} >Kelas 12</option>
                            </select>
                            </div>
                        </div>
